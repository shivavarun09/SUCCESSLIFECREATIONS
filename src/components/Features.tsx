...
const items = [
  {
    ...
    description:
      'Custom, responsive, and performance-focused websites built to represent your brand clearly and provide a smooth user experience across all devices.',
  ...
  },
  {
    ...
    description:
      'Ongoing website maintenance including updates, bug fixes, performance improvements, and reliable technical support when you need it.',
  ...
  },
  {
    ...
    description:
      'Well-planned digital marketing, SEO, and social media strategies designed to improve online visibility, engagement, and long-term growth.',
...
export default function Features() {
  ...
  return (
    ...
    Reliable Web Development & Digital Marketing Services
        </Typography>
      </Box>
      <Box
        sx={{
